...
describe('Test the built result of the remote content ', function() {
	it('[example 01] when contents is the pure js, should return correct js using the required .ajs file', function() {
		...
		var content = fs.readFileSync(path.join(__dirname, '../examples/example01--basic-usage/dist/js/test.js') , {encoding:"utf-8"});
	...
	it('[example 02] when contents is the react template, should return correct js using the required .ajs file', function() {
		this.timeout(50000);
		rm('-rf', './examples/example02--usage-with-rt/dist/');
		exec('node node_modules/webpack/bin/webpack.js -p --config examples/example02--usage-with-rt/webpack.config.js --content-base examples/example02--usage-with-rt/');
		var content = fs.readFileSync(path.join(__dirname, '../examples/example02--usage-with-rt/dist/js/test.js') , {encoding:"utf-8"});
	...
	it('[example 03] when contents is the pure js with queryString to get, should return correct js using the required .ajs file', function() {
		...
		var content = fs.readFileSync(path.join(__dirname, '../examples/example03--usage-with-queryString/dist/js/test.js') , {encoding:"utf-8"});
	...
	it('[example 04] when contents is the react template with queryString to get, should return correct js using the required .ajs file', function() {
		this.timeout(50000);
		rm('-rf', './examples/example04--usage-with-rt-queryString/dist/');
		exec('node node_modules/webpack/bin/webpack.js -p --config examples/example04--usage-with-rt-queryString/webpack.config.js --content-base examples/example04--usage-with-rt-queryString/')
		var content = fs.readFileSync(path.join(__dirname, '../examples/example04--usage-with-rt-queryString/dist/js/test.js') , {encoding:"utf-8"});
	...
	it('[example 05] when custom preParser is set, should return correct js using the required .ajs file', function() {
		...
		var content = fs.readFileSync(path.join(__dirname, '../examples/example05--usage-with-preParser/dist/js/test.js') , {encoding:"utf-8"});
...
describe('Test the built result of the local content ', function() {
	it('[example 06] when contents is the pure js, should return correct js using the required .ajs file', function() {
		...
		var content = fs.readFileSync(path.join(__dirname, '../examples/example06--usage-with-local/dist/js/test.js') , {encoding:"utf-8"});
	...
	it('[example 07] when contents is the react template, should return correct js using the required .ajs file', function() {
		this.timeout(50000);
		rm('-rf', './examples/example07--usage-with-rt-local/dist/');
		exec('node node_modules/webpack/bin/webpack.js -p --config examples/example07--usage-with-rt-local/webpack.config.js --content-base examples/example07--usage-with-rt-local/');
		var content = fs.readFileSync(path.join(__dirname, '../examples/example07--usage-with-rt-local/dist/js/test.js') , {encoding:"utf-8"});
